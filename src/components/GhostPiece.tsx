...
const LINE_RADIUS = 0.2; // Slightly thinner than the real piece
  ...
  return (
    <mesh>
      ...
      <meshBasicMaterial
        color={GHOST_COLOR}
        transparent
        opacity={0.25} // Low opacity for "Ghost" effect
        depthWrite={false} // Prevents z-fighting with the real piece if they overlap
      />
    </mesh>
  );
};

// --- Edge Calculation Logic (Reused from FallingPiece pattern) ---
// Note: In a larger refactor, this logic could be extracted to a hook "usePieceGeometry"
